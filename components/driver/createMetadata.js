    ...
    return (
        <div>
            <div className="hidden sm:block " aria-hidden="true">
                <div className="pt-10 pb-3 grid justify-center">
                    <div className="text-5xl">เพิ่มข้อมูลส่วนตัว</div>
                </div>
            </div>
                                        ...
                                        <div className="col-span-6 sm:col-span-4">
                                            ...
                                            {ageFromString < 22 ?
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    className="bg-red-100 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm rounded-md" />
                                                :
                                                <input
                                                    type="date"
                                                    name="dateOfBirth"
                                                    value={metadataInfo.dateOfBirth}
                                                    onChange={handleChange}
                                                    className="bg-green-100 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm rounded-md" />
                                            }
                                        </div>
                                        ...
                                        <div className="col-span-6 sm:col-span-6">
                                            ...
                                            {Chk ?
                                                <input
                                                    ...
                                                    className="my-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md bg-green-100" />
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    onBlur={() => ChkDigitPid(metadataInfo.idCard)}
                                                    className="my-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md bg-red-100" />
